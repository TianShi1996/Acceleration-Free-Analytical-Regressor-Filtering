...
ss={'-.','-'};Ts=1e-3;
if task==1
    t=0:Ts:25;filename='traj3_pre_err_1.gif';
    xind=[0,25];yind=[0,8];ind0=0;ticks=0:2:6;pose=[-2.5,4];
else
    t=130:Ts:155;filename='traj3_pre_err_2.gif';
    xind=[130,155];yind=[0,6];ind0=130/Ts;ticks=0:3:6;pose=[-2.5+130,3];
end
...
for i=1:length(t)/dur
    ...
    ylabel('{\boldmath$\|\varepsilon\|$} (N.m)','Interpreter','latex','FontSize',ftsize,'Position',pose);
