...
ss={'-.','-'};Ts=1e-3;
if task==1
    t=0:Ts:25;filename='traj3_err_norm_1.gif';
    xind=[0,25];yind=[0,0.08];ind0=0;ticks=0:0.04:0.08;pose=[-2.5,0.04];
else
    t=130:Ts:155;filename='traj3_err_norm_2.gif';
    xind=[130,155];yind=[0,0.2];ind0=130/Ts;ticks=0:0.1:0.2;pose=[-2.5+130,0.1];
end
...
for i=1:length(t)/dur
    ...
    ylabel('{\boldmath$\|e_1\|$} (rad)','Interpreter','latex','FontSize',ftsize,'Position',pose);
