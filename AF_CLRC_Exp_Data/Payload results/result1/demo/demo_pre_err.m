...
ss={'-.','-'};Ts=1e-3;
if task==1
    t=0:Ts:25;filename='pre_err_1.gif';
    xind=[0,25];yind=[0,17];ind0=0;ticks=0:5:15;y_pose=[-2.5,17/2];
else
    t=130:Ts:145;filename='pre_err_2.gif';
    xind=[130,145];yind=[0,6];ind0=130/Ts;ticks=0:3:6;y_pose=[130-2.5/25*15,3];
end
