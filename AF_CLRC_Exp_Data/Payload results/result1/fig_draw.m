...
text(-3.5/25*150,7,"(a)",'FontName','Times New Roman','FontSize',ftsize);
% xlabel('Time (s)');
ylabel('$\|\hat W\|$','Interpreter','latex','Position',[-12,3.5]);
...
axis([0,25,0,100]);
legend('MSLC','DDF-CLRC','AF-CLRC','NumColumns',3,'FontSize',10,'box','off');
text(-3.5,100,"(b)",'FontName','Times New Roman','FontSize',ftsize);
% xlabel('Time (s)');
ylabel('\boldmath{$\|\tau_{\rm{J}}\|$} (N.m)','Interpreter','latex','Position',[-2,50]);
set(gca,'FontName','Times New Roman','FontSize',ftsize);

axes('Position',[0.3,0.6,0.20,0.17]);
plot(t(T1),tau_a_mc(T1),':', 'color', color_m,'linewidth',linwid);hold on;
plot(t(T1),tau_a_ddf1(T1),'-.', 'color', color_a1,'linewidth',linwid-0.5);hold on;
plot(t(T1),tau_a_f(T1),'-', 'color', color_f,'linewidth',linwid);hold on;
axis([12.8,13.2,56,62]);
set(gca,'FontName','Times New Roman','FontSize',ftsize-2);
...
axis([0,25,0,0.12]);
legend('MSLC','DDF-CLRC','AF-CLRC','NumColumns',3,'FontSize',10,'box','off');
text(-3.5,0.12,"(c)",'FontName','Times New Roman','FontSize',ftsize);
...
axis([130,145,0,10]);
legend('DDF-CLRC','AF-CLRC','NumColumns',3,'FontSize',10,'box','off');
text(-3.5/25*15+130,10,"(f)",'FontName','Times New Roman','FontSize',ftsize);
xlabel('Time (s)');
ylabel('\boldmath{$\|\varepsilon\|$} (N.m)','Interpreter','latex','Position',[130-1.25,5]);
set(gca,'FontName','Times New Roman','FontSize',ftsize);
