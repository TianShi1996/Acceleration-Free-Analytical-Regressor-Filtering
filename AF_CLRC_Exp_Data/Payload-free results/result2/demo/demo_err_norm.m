...
ss={'-.','-'};Ts=1e-3;
if task==1
    t=0:Ts:25;filename='traj2_err_norm_1.gif';
    xind=[0,25];yind=[0,0.08];ind0=0;ticks=0:0.04:0.08;y_pose=[-2.5,0.04];
else
    t=130:Ts:150;filename='traj2_err_norm_2.gif';
    xind=[130,150];yind=[0,0.28];ind0=130/Ts;ticks=0.0:0.14:0.28;y_pose=[130-2.5/25*20,0.14];
end
